...
import { hospitalData } from "../../../data/hospitalWebsiteData";
import CurrencyToggle from "../gym/CurrencyToggle";

const SERVICE_LABEL = "Hospital";
...
const HospitalPricing = () => {
  ...
  const plans = hospitalData[currency];
        ...
        <div className="mt-20 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {plans.map((plan) => (
            <motion.article
              ...
              viewport={{ once: true }}
              className={`group relative overflow-hidden rounded-[32px] border p-6 backdrop-blur-3xl transition-all duration-500 ${
                plan.highlighted
            ...
            >
              ...
              <div className="mt-6 flex flex-col gap-3">
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 py-4 text-white font-semibold hover:scale-[1.02] transition-all duration-300"
                >
                  <Download size={18} />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full inline-flex items-center justify-center gap-2 rounded-2xl border border-cyan-500/20 bg-cyan-500/5 py-4 text-cyan-700 font-semibold"
                >
                  <Download size={18} />
                  Presskit PDF
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full inline-flex items-center justify-center rounded-2xl bg-green-500 py-4 text-white font-semibold"
                >
                  Send On WhatsApp
                </a>
              </div>
