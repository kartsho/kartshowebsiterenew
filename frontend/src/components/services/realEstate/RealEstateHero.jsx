...
const trustPills = ["Property Listings", "Agent Profiles", "Lead Forms", "Search Filters"];

const statCards = [
  { value: "24/7", label: "Lead capture", className: "top-8 left-0 lg:left-10" },
  { value: "250+", label: "Listings showcased", className: "top-28 right-0 lg:right-8" },
  { value: "96%", label: "Inquiry clarity", className: "bottom-28 left-0" },
  { value: "40+", label: "Project pages", className: "bottom-8 right-10" },
];
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-6 lg:grid-cols-2 lg:gap-20">
        ...
        <div className="relative hidden h-[700px] items-center justify-center lg:flex">
          ...
          <motion.div animate={{ y: [0, -15, 0] }} transition={{ duration: 6, repeat: Infinity }} className="relative h-[540px] w-[420px] overflow-hidden rounded-[40px] border border-white/70 bg-white/80 shadow-[0_30px_120px_rgba(15,23,42,0.12)] backdrop-blur-3xl">
            ...
            <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1200&auto=format&fit=crop" alt="Real estate" className="absolute inset-0 h-full w-full object-cover opacity-85" />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <h3 className="mt-5 text-3xl font-black text-white">Modern Property Experience</h3>
              <p className="mt-4 leading-relaxed text-slate-200">
                Visual listings, lead capture, and browsing flows that make property search easier.
              </p>
            </div>
          </motion.div>
